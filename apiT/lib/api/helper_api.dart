...
class HelperApi {
  ...
  ///
  /// 
  Future<Response> apiV1HelperGenderPostWithHttpInfo() async {
    Object postBody;
  ...
  ///
  /// 
  Future<List<Gender>> apiV1HelperGenderPost() async {
    Response response = await apiV1HelperGenderPostWithHttpInfo();
    if(response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if(response.body != null) {
