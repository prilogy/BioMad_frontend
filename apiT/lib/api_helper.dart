...
String parameterToString(dynamic value) {
  ...
  } else if (value is BiomarkerReferenceConfigDependencyType) {
    return BiomarkerReferenceConfigDependencyTypeTypeTransformer().encode(value).toString();
  } else if (value is Types) {
    return TypesTypeTransformer().encode(value).toString();
  } else {
