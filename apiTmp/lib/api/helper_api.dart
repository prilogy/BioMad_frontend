...
class HelperApi {
  ...
  /// Searches resources by query with HTTP info returned
  ///
  /// 
  Future<Response> apiV1HelperSearchPostWithHttpInfo(String body) async {
    ...
    // create path and map variables
    String path = "/api/v1/Helper/search".replaceAll("{format}","json");
  ...
  ///
  /// 
  Future<List<Biomarker>> apiV1HelperSearchPost(String body) async {
    Response response = await apiV1HelperSearchPostWithHttpInfo(body);
    if(response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if(response.body != null) {
