...
class AuthenticationResult {
  ...
  static Map<String, AuthenticationResult> mapFromJson(Map<String, dynamic> json) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = AuthenticationResult.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of AuthenticationResult-objects as value to a dart map
  static Map<String, List<AuthenticationResult>> mapListFromJson(Map<String, dynamic> json) {
