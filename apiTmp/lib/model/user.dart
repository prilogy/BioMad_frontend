...
class User {
  ...
  @override
  String toString() {
    return 'User[id=$id, email=$email, emailIsVerified=$emailIsVerified, password=$password, dateCreatedAt=$dateCreatedAt, cultureId=$cultureId, culture=$culture, members=$members, analyzes=$analyzes, currentMemberId=$currentMemberId, socialAccounts=$socialAccounts, confirmationCodes=$confirmationCodes, roleId=$roleId, role=$role, refreshTokens=$refreshTokens, ]';
  }
