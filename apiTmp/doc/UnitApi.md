...
[**apiV1UnitSearchPost**](UnitApi.md#apiV1UnitSearchPost) | **POST** /api/v1/Unit/search | Searches units by query
...
# **apiV1UnitSearchPost**
> List<Unit> apiV1UnitSearchPost(body, page, pageSize, orderByDate)
...
try { 
    var result = api_instance.apiV1UnitSearchPost(body, page, pageSize, orderByDate);
    print(result);
} catch (e) {
    print("Exception when calling UnitApi->apiV1UnitSearchPost: $e\n");
}
```
