...
void main() {
  ...
  group('tests for UnitApi', () {
    ...
    test('test apiV1UnitIdGet', () async {
      // TODO
    });
    ...
    test('test apiV1UnitSearchPost', () async {
      // TODO
    });
