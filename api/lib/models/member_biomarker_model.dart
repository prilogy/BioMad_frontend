...
class MemberBiomarkerModel {
  ...
  MemberBiomarkerModel(
      ...
      this.unitId,
      this.biomarkerName,
      this.biomarkerUnitName});

  @override
  String toString() {
    return 'MemberBiomarkerModel[value=$value, analysisId=$analysisId, biomarkerId=$biomarkerId, unitId=$unitId, biomarkerName = $biomarkerName, biomarkerUnitName = $biomarkerUnitName]';
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (analysisId != null) json['analysisId'] = analysisId;
  ...
  static List<MemberBiomarkerModel> listFromJson(List<dynamic> json) {
    return json == null
        ? List<MemberBiomarkerModel>()
        : json.map((value) => MemberBiomarkerModel.fromJson(value)).toList();
  }

  static Map<String, MemberBiomarkerModel> mapFromJson(
      Map<String, dynamic> json) {
    var map = Map<String, MemberBiomarkerModel>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) =>
          map[key] = MemberBiomarkerModel.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of MemberBiomarkerModel-objects as value to a dart map
  static Map<String, List<MemberBiomarkerModel>> mapListFromJson(
      Map<String, dynamic> json) {
