...
class MemberBiomarkerReferenceModel {
  ...
  static List<MemberBiomarkerReferenceModel> listFromJson(List<dynamic> json) {
    return json == null ? List<MemberBiomarkerReferenceModel>() : json.map((value) => MemberBiomarkerReferenceModel.fromJson(value)).toList();
  }

  static Map<String, MemberBiomarkerReferenceModel> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, MemberBiomarkerReferenceModel>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = MemberBiomarkerReferenceModel.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of MemberBiomarkerReferenceModel-objects as value to a dart map
  static Map<String, List<MemberBiomarkerReferenceModel>> mapListFromJson(Map<String, dynamic> json) {
